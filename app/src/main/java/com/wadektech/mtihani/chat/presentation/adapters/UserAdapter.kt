package com.wadektech.mtihani.chat.presentation.adapters
...
import com.wadektech.mtihani.chat.presentation.ui.ProfileFragment
...
import com.wadektech.mtihani.chat.presentation.ui.MessageActivity
...
class UserAdapter(private val context: Context, private val isChatting: Boolean)
    : PagedListAdapter<User?, UserAdapter.ViewHolder>(
    User.DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.mProfileImage.setOnClickListener {
            ...
            val pfs: SharedPreferences = context.getSharedPreferences(
